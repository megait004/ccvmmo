<template>
  ...
  >
    ...
    <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-700">
      <NuxtLink
        to="/"
        class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-700 transition-colors text-gray-300"
      >
  ...
  <div
    class="lg:hidden fixed inset-0 bg-black/50 z-40 admin-overlay hidden"
    @click="closeSidebar"
  ></div>
</template>
